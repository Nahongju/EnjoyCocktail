...
try {
  ...
  $sql = "SELECT Picture, Name FROM Info1 WHERE Type LIKE :Type";
  ...
  $stmh -> bindValue(':Type', $TypeName, PDO::PARAM_STR);
  $stmh -> execute();
  ...
  <div style="position:absolute;left:580px;top:-15px;margin-right:10px;width:500px">
  <h1 style="font-size:400%;color:Orange;font-family:courier"><?=htmlspecialchars($TypeName)?></h1>
  </div>

  <!--Go to Usage-->
  <div style="position:absolute;left:1370px;top:50px;width:150px">
  <img src="logo.png" style="width:20px;height:20px">
  <a class="main" href="http://1.247.212.109:8012/Usage.html" title="Usage로 가려면 클릭하세요">Go to usage</a>
  </div>

  <!--검색창-->
  <div style="position:absolute;left:265px;top:180px;width:250px">
  <input type="text">
