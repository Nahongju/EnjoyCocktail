...
try {
  ...
  $sql = "SELECT Name, Picture FROM Info1 WHERE CNo > 0 AND CNo < 17";
  ...
  ?>
    ...
    <option>정렬방식</option>
    <option value="01">베이스정렬</option>
    <option value="02">용도 정렬</option>
    <option value="03">무알코올 정렬</option>
    </select>
    </div>
    ...
    <!--Best4 칵테일-->
    <div style="position:absolute;left:265px;top:120px">
    <h3>Best 4</h3>
    </div>
    ...
    <!--칵테일 사진 테이블-->
    <form Name="CocktailTable" action="cocktailInformation.php" method="post">
    ...
    <!--Pagination-->
    <div class="pagination" style="position:absolute;top:1900px;left:600px">
    	<a href="#">&laquo;</a>
    	<a href="#" class="active">1</a>
    	<a href="http://1.247.212.109:8012/All_p2.html">2</a>
    	<a href="http://1.247.212.109:8012/All_p3.html">3</a>
    	<a href="http://1.247.212.109:8012/All_p4.html">4</a>
    	<a href="#">&raquo;</a>
    </div>
